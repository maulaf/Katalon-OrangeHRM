...
assert headerDialog == "Share Photos"

WebUI.verifyElementAttributeValue(findTestObject('Object Repository/buzz/dialog_textareaPost'), "placeholder", "What's on your mind?", 0)