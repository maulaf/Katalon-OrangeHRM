...
WebUI.click(findTestObject('Object Repository/general/btn_Yes Delete'))

WebUI.verifyElementText(findTestObject('Object Repository/general/toast'), "Successfully Deleted")