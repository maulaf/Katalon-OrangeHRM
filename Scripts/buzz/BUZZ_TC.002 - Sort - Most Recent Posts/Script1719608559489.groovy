...
WebUI.click(findTestObject('Object Repository/buzz/btn_Most Recent Post'))

//TestObject selectorType = new TestObject()
//selectorType.addProperty('class', ConditionType.EQUALS, 'oxd-text oxd-text--p orangehrm-buzz-post-time')
//
