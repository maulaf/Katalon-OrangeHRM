...
// Klik untuk mengurutkan berdasarkan Username
WebUI.click(findTestObject('Object Repository/admin/user management/sort_Username'))

// Klik untuk mengurutkan secara ascending
WebUI.click(findTestObject('Object Repository/general/sort_ASC'))

// Buat TestObject untuk mencari elemen berdasarkan CSS
TestObject selectorType = new TestObject()
selectorType.addProperty('css', ConditionType.EQUALS, '.oxd-table-body > div > .oxd-table-row')

// Temukan daftar elemen yang sesuai dengan selectorType
List<WebElement> typeList = WebUI.findWebElements(selectorType, 30)
int size = typeList.size()

// Buat array list untuk menyimpan nilai tabel
ArrayList<String> tableValues = new ArrayList<String>()

// Ambil teks dari setiap baris dan simpan ke dalam array list
for (int i = 1; i <= size; i++) {
	String css = ".oxd-table-body > div:nth-of-type(" + i + ") div:nth-of-type(2)"
...
//	String upper = str.toUpperCase().replace(" ", "")
	tableValues.add(str)
}

System.out.println(tableValues)

// Buat salinan dari nilai tabel untuk referensi
ArrayList<String> referenceValues = new ArrayList<String>(tableValues)

// Urutkan nilai referensi secara ascending
Collections.sort(referenceValues)
System.out.println(referenceValues)

// Verifikasi apakah nilai tabel sudah terurut dengan benar
